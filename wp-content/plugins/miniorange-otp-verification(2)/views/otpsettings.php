                            ...
                            <td>
                                <h3>
                                    '.mo_("CUSTOMIZE THE OTP FORMAT:").'
										<span style="float:right;margin-top:-10px;">
                                        <input  type="submit" '.$alphanumeric_disabled.'
                                                name="save"
                                                class="button button-primary button-large"
                                                value="'.mo_("Save Settings").'"/>
                                    </span>
                             ...
                             <td> 
                                 <div>
                                        <i><b>Note</b>: This feature enable admin to customize the OTP Format, including lowercase, uppercase, and numeric characters.<b> For eg: aB23Fm</b></i>
                                    </div>
                         </td>
                    </tr>
            ...
            <div id="globallyBannedPhone" class="mo_registration_table_layout mo-otp-half">
                    <table style="width:100%">
                            ...
                            <td>
                                <h3>
                                    '.mo_("GLOBALLY BANNED PHONE NUMBERS:").'
                                        <span style="float:right;margin-top:-10px;">
                                        <input  type="submit" '.$globallybanned_disabled.'
                                                name="save"
                                                class="button button-primary button-large"
                                                value="'.mo_("Save Settings").'"/>
                                    </span>
                        ...
                        <tr>
                             <td>
                                 <div >
                                        <i><b>Note</b>: This feature enabled admin to block the use of globally banned phone number formats, hence increases security.<b> For eg: +1111111111 will get blocked.</b></i>
                                    </div>
                             </td>
                        </tr>
