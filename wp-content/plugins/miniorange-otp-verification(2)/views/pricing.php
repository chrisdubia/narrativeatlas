    ...
    <div class="mo_registration_divided_layout mo-otp-full">
        ...
        <div class="mo-cd-pricing-switcher">
                    <p class="fieldset" style="background-color: #266184;">
                        ...
                        <input type="radio" class="mo_price_selector" name="sitetype" value="monthly_plan" id="monthly_plan" onclick="mo_otp_show_monthly_plan();">
                        <label for="monthly_plan">Monthly SMS</label>
                    </p>
                    </p>
                    </div>
...
<div class="mo_main_price_table">
    <table class="mo_price-table">
        ...
        echo'                </td>
                ...
                echo '      </td>
                                <td class="mo_price"><div class="mo_charges">$39</div><br><br><br><br>
                                <div class="mo_plan_description">
                ...
                echo '
                                ...
                                <td class="mo_price"><div class="mo_charges">$89</div><br><br><br><br>
                                <div class="mo_plan_description">
                                miniOrange + AWS SNS
...
echo '<div id="mo_otp_show_monthly_plan" hidden>
            <table class="mo_registration_pricing_table">
                <h2>'.mo_("MONTHLY TRANSACTIONAL PLAN").'
                    <span style="float:right">
                    <input type="button"  name="Supported_payment_methods" id="pmt_btn_addon"
                                class="button button-primary button-large" value="'.mo_("Supported Payment Methods").'"/>
                        <input type="button" '.$disabled.' name="check_btn" id="check_btn"
                ...
                <h2>
                <hr>
                <table class="mo_price-table mo-monthly">
                <tbody>
                <tr class="mo_price-table-head mo-monthly">
                <td colspan="2">miniorange SMS/Email Monthly Plan</td>
                </tr>
                <tr class="mo-monthly-description">
                <td>A monthly subscription module using miniOrange SMS/SMTP Gateway.<br> Never have the need to recharge for SMS or Email transactions manually. All you need to do is follow the steps below and reach out to us with your subsctipton module, we will activate it for you.<br><br>Follow the steps below:<br><li>Select your target country from the list shown on the right.</li><li>Enter the number of monthly SMS/Email transactions that you wish to activate for the monthly subscription.</li><li>Once entered, click on the button to send the information to us.</li></td>
                <td><br><strong>'.mo_("Select your Target Country").': </strong>';
                get_country_code_dropdown();
                echo '<br><br><strong>'.mo_("Enter the monthly SMS Transaction amount").': </strong>
                <input type="number" placeholder=100 class="mo_monthly_sms" id="mo_monthly_sms"></input>

                <br><br><strong>'.mo_("Enter the monthly Email Transaction amount").': </strong>
                <input type="number" placeholder = 100 class="mo_monthly_email" id="mo_monthly_email"></input><br><br>
                <span class=mo_monthly_note style="color:red;"> You can leave the value empty or null if you dont wish to opt for both sms and email monthly plan</span><br><br>
                <input type="button" name="mo_monthly_submit" class="mo_dollar_price button button-primary button-large"
                                value="'.mo_("Send Information").'" onclick="mo_get_montly_plan_data();" />
                </td>
                </tr>
                </tbody>
                </table>
