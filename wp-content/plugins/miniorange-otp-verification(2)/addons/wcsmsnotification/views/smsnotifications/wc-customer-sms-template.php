...
echo'	<div class="mo_registration_divided_layout mo-otp-full">
	...
	echo'			<table id="wc_customer_sms_template" style="width:100%">
						<form name="f" method="post" action="" id="'.$formOptions.'">
							...
							<tr>
								<td>
									<h4 style="margin-top: -11px">'.mo_("SMS Body");
...
$html1 = 				'<tr>
								<td colspan="2">
									<div class="mo_otp_note">
										'.mo_('<b><u>For Indian Traffic Only</u> : The above templates are the default registered templates. Do not make edits in the templates since it may lead to failure in delivery.<br>If you wish to customize the SMS Template, kindly contact us at <a onClick="otpSupportOnClick();"><u> otpsupport@xecurify.com</u></a>.</b>').'
									</div>';
...
echo '            
										<div class="mo_otp_note">
										'.mo_('If you are looking for the extra <b>Tags</b> in SMS Body, Please kindly contact us at <a onClick="otpSupportOnClick();"><u> otpsupport@xecurify.com</u></a>.').'
									</div>
								</td>
							</tr>
						 </form>	
