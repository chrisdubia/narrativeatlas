...
$html1 =   '<tr>
                ...
                <b>'.mo_("Choose Template: ").'</b>
                 <input type="radio" '.$disabled.' class="mo_custom_message_enable" id="mo_custom_msg_template1" checked="checked" name="mo_customer_validation_custom_message_template1" value="Template1">
                                    <label for="mo_custom_msg_template1">Template 1</label>&nbsp


                 <input type="radio" '.$disabled.' class="mo_custom_message_enable" id="mo_custom_msg_template2" name="mo_customer_validation_custom_message_template2"  value="Template2">
                                    <label for="mo_custom_msg_template2">Template 2</label>&nbsp <br><br>
                    ...
                    <td>
                        ...
                        <textarea '.$disabled.' 
                           ...
                           <div class="mo_otp_note">
                            '.mo_('<b>Note : Only {##var##} of the template is editable. Do not replace the other fixed values.</b>').'
                        </div>
                        <div class="mo_otp_note">
                        ...
                        <div class="mo_otp_note"><b>If you wish to customize the Template, contact us at <a onClick="otpSupportOnClick();"><u> otpsupport@xecurify.com</u></a></b>.
                        </div>
                    </td>
                </tr>';
...
echo (MoUtility::moGetCountryNameFromIP()=='India' ? $html1 :$html2) ;
