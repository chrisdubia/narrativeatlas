<?php
/**
 * Narrativeatlas AWS Transcoder Autoload Implementation.
 *
...
/**
 * Auto Loader for Narrativeatlas_AWS_Transcoder.
 *
 * After registering this autoload function with SPL, the following line
 * would cause the function to attempt to load the Narrativeatlas_AWS_Transcoder\Bar\Baz\Qux class
 * from /path/to/wp-content/plugins/narrativeatlas-aws-transcoder/src/bar/baz/class-qux.php:
 *
 *      new Narrativeatlas_AWS_Transcoder\Baz_Xyz\Qux;
 *  maps to /path/to/wp-content/plugins/narrativeatlas-aws-transcoder/src/bar/baz-xyz/class-qux.php
...
class Autoloader {
	...
	/**
	 * Namespace root. eg. Narrativeatlas_AWS_Transcoder\\(escaped slashes);
	 *
	 * @var string
	 */
