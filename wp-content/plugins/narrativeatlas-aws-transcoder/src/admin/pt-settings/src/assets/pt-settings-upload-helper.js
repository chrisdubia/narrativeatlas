...
jQuery(document).ready(function ($) {
    ...
    $('.pt-settings-upload-image-button').click(function (e) {
        ...
        custom_uploader.on('select', function () {
            ...
            $('#' + get_id($this.data('id'))).val(attachment.sizes.thumbnail.url);

            //now update image
            $this.siblings('.pt-settings-image-placeholder').find('img').show().attr('src', attachment.sizes.thumbnail.url);
