	...
	<div class="cmlp-left cmlp-box cmlp-padding">
		<div  class="postbox">
			...
			<div class="cmlp-inside">
				...
				<p><a href="https://www.cminds.com/guest-account/"  target="_blank" class="buttonblue">Access Customers Dashboard</a></p>
				<hr/>
       ...
       <div  class="postbox">
            ...
            <div class="inside">
                ...
                <style>
					...
					#mlb2-8021402 a:active { overflow: visible; position: static; background: none; border: none; bottom: auto; clear: none; cursor: default; float: none; letter-spacing: normal; line-height: normal; text-align: left; text-indent: 0; text-transform: none; visibility: visible; white-space: normal; max-height: none; max-width: none; left: auto; min-height: 0; min-width: 0; right: auto; top: auto; width: auto; z-index: auto; text-shadow: none; box-shadow: none; outline: medium none; }
					#mlb2-8021402 a:hover { cursor: pointer !important; }
					#mlb2-8021402 h4 { font-weight: normal; }
					#mlb2-8021402 .subscribe-form { padding: 20px; width: 500px !important; border: 2px solid #F6F6F6 !important; background: #f6f6f6 none !important; border-radius: 0px !important; box-sizing: border-box !important; }
					#mlb2-8021402 .ml-block-form { margin-bottom: 0px; }
					#mlb2-8021402 .subscribe-form .form-section { margin-bottom: 20px; width: 100%; }
					#mlb2-8021402 .subscribe-form .form-section.mb10 { margin-bottom: 10px; float: left; }
					#mlb2-8021402 .subscribe-form .form-section.mb0 { margin-bottom: 0px; }
					#mlb2-8021402 .subscribe-form .form-section h4 { margin: 0px 0px 10px 0px !important; padding: 0px !important; color: #000000 !important; font-family: 'Open Sans', sans-serif !important; font-size: 28px !important; line-height: 100%; text-align: left !important; }
					#mlb2-8021402 .subscribe-form .form-section p,
					#mlb2-8021402 .subscribe-form .form-section li { line-height: 150%; padding: 0px !important; margin: 0px 0px 10px 0px; color: #000000 !important; font-family: 'Open Sans', sans-serif !important; font-size: 14px !important; }
					#mlb2-8021402 .subscribe-form .form-section a { font-size: 14px !important; }
					#mlb2-8021402 .subscribe-form .form-section .confirmation_checkbox { line-height: 150%; padding: 0px !important; margin: 0px 0px 15px 0px !important; color: #000000 !important; font-family: 'Open Sans', sans-serif !important; font-size: 12px !important; font-weight: normal !important; }
					#mlb2-8021402 .subscribe-form .form-section .confirmation_checkbox input[type="checkbox"] { margin-right: 5px !important; }
					#mlb2-8021402 .subscribe-form .form-section .form-group { margin-bottom: 15px; }
					#mlb2-8021402 .subscribe-form .form-section .form-group label { float: left; margin-bottom: 10px; width: 100%; line-height: 100%; color: #000000 !important; font-family: 'Open Sans', sans-serif !important; font-size: 14px !important; }
					#mlb2-8021402 .subscribe-form .form-section .checkbox { width: 100%; margin: 0px 0px 10px 0px; }
					#mlb2-8021402 .subscribe-form .form-section .checkbox label { color: #000000 !important; font-family: 'Open Sans', sans-serif !important; font-size: 14px !important; }
					#mlb2-8021402 .subscribe-form .form-section .checkbox input { margin: 0px 5px 0px 0px; }
					#mlb2-8021402 .subscribe-form .form-section .checkbox input[type=checkbox] { -webkit-appearance: checkbox; opacity: 1; }
					#mlb2-8021402.ml-subscribe-form .form-group .form-control { width: 100%; font-size: 13px; padding: 10px 10px; height: auto; font-family: Arial; border-radius: 0px; border: 1px solid #cccccc !important; color: #000000 !important; background-color: #FFFFFF !important; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box; clear: left; }
					#mlb2-8021402.ml-subscribe-form button { border: none !important; cursor: pointer !important; width: 100% !important; border-radius: 0px !important; height: 40px !important; background-color: #87b87f !important; color: #FFFFFF !important; font-family: 'Arial', sans-serif !important; font-size: 16px !important; text-align: center !important; padding: 0 !important; margin: 0 !important; position: relative!important; }
					...
					#mlb2-8021402.ml-subscribe-form button[disabled] { cursor: not-allowed!important; }
					#mlb2-8021402.ml-subscribe-form .form-section.ml-error label { color: red!important; }
					#mlb2-8021402.ml-subscribe-form .form-group.ml-error label { color: red!important; }
					#mlb2-8021402.ml-subscribe-form .form-group.ml-error .form-control { border-color: red!important; }
                    @media (max-width: 768px) {
                        #mlb2-8021402 { width: 100% !important; }
                        #mlb2-8021402 form.ml-block-form,
                        #mlb2-8021402.ml-subscribe-form .subscribe-form { width: 100% !important; }
                    }
                </style>
                ...
                <p><a href="<?php echo $this->addAffiliateCode( 'https://www.cminds.com/referral-program/' ); ?>"  target="_blank" class="buttonblue">Affiliate Program</a></p>
            </div>
        </div>
		<div  class="postbox">
