<?php
namespace com\cminds\package\pro\v1_9_2;
        ...
        public function license_page() {
            ...
            <div class="cmlp-inside">
                ...
                <ol>
                    ...
                    <li>If all the above does not work please <a href="https://www.cminds.com/wordpress-plugin-customer-support-ticket/"  target="_blank" class="">Open a Support Ticket</a></li>
                </ol>
            </div>
            <?php
        ...
        public function update_page_short() {
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
						<a class="button submit-btn submit-button" href="<?php echo esc_attr(add_query_arg(array('check' => urlencode($this->pluginSlug)))); ?>">Check for updates</a>
                        <a class="button submit-btn submit-button" href="<?php echo esc_attr(add_query_arg(array('check' => urlencode($this->pluginSlug)))); ?>">Refresh license details</a>
					</td>
                </tr>
            </table>
            <?php
