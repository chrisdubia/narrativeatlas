...
class FreeController extends Controller {
	...
	static function admin_menu() {
		/*
 		...
 		add_submenu_page(App::PREFIX, 'Upgrade to '. App::getPluginName() .' Pro', 'Upgrade to Pro', 'manage_options', self::getMenuSlug('upgrade'), array(get_called_class(), 'upgradeToPro'));
		*/
	}
