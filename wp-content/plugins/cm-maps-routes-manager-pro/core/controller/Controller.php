...
abstract class Controller {
	...
	*/
	...
	static function loadView($_viewName, $_params = array(), $override = false) {
		if($override == true) {
			extract($_params);
			ob_start();
			include $_viewName;
	...
	static function loadFrontendView($_viewName, $_params = array(), $override = false) {
		if($override == false) {
			$_viewName = 'frontend' . DIRECTORY_SEPARATOR . strtolower(static::shortClassName()) . DIRECTORY_SEPARATOR . $_viewName;
		}
		return static::loadView($_viewName, $_params, $override);
	}
