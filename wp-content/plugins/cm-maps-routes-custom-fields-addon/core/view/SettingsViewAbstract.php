...
namespace com\cminds\mapsroutesmanager\addon\customfields\view;
...
abstract class SettingsViewAbstract {
	...
	public function renderCategory($category) {
		...
		return '<div class="settings-category settings-category-'. $category .'">'. apply_filters('cmmrmcf-settings-category', $result, $category) .'</div>';
	}
	...
	public function renderSubcategory($category, $subcategory) {
		...
		return '<div class="settings_'. $category .'_'. $subcategory .'">'. apply_filters('cmmrmcf-settings-subcategory', $result, $category, $subcategory) .'</div>';
	}
