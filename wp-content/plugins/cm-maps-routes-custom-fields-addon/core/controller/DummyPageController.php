...
use com\cminds\mapsroutesmanager\addon\customfields\helper\DateTimeHelper;

use com\cminds\mapsroutesmanager\addon\customfields\model\User;

abstract class DummyPageController extends Controller {
	
	const QUERY_DUMMY_PAGE = 'cmmrmcf_dummy_page';
