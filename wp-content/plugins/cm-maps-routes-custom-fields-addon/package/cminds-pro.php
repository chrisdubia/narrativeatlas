...
namespace com\cminds\package\pro\v1_9_1;

if ( !defined( __NAMESPACE__ . '\PLATFORM_VERSION' ) ) {
    define( __NAMESPACE__ . '\PLATFORM_VERSION', 'v1_9_1' );
}
if ( !class_exists( __NAMESPACE__ . '\CmindsProPackage' ) ) {
    ...
    class CmindsProPackage {
        ...
        public function __construct( $config ) {
            ...
            add_shortcode( 'cminds_pro_ads', array( $this, 'showAds' ) );
            add_shortcode( 'cminds_pro_guide', array( $this, 'showGuide' ) );
