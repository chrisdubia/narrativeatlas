...
$can_invite_members_local = is_super_admin();
...
if ( function_exists( 'bp_post_get_permalink' ) ) { // ugly ugly ugly hack to check for pre-1.2 versions of BP
	...
	<?php if ( invite_anyone_access_test() && !bp_is_group_create() ) : ?>
		<p> <a href="<?php echo bp_loggedin_user_domain() . BP_INVITE_ANYONE_SLUG . '/invite-new-members/group-invites/' . bp_get_group_id() ?>"><?php _e( 'Send invitations by email.', 'invite-anyone' ) ?></a></p>
	<?php endif; ?>

	<?php if( $can_invite_members_local ):?>
