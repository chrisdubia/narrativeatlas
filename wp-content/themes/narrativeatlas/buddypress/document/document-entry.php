...
if ( $attachment_id ) {
	...
	$can_manage      = ( true === (bool) $document_privacy['can_edit'] ) ? true : false;
	...
	$attachment_url = bp_document_get_preview_url(  bp_get_document_id(), bp_get_document_preview_attachment_id() );
	...
	$can_manage   = ( true === (bool) $folder_privacy['can_edit'] ) ? true : false;
